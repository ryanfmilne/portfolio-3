...
export const metadata: Metadata = {
  title: 'Print Management Platform | Ryan Milne',
  description:
    'Private print management platform project placeholder for Ryan Milne developer portfolio.'
}

export default function PrintManagementPlatformPage() {
  return (
    <div className='flex flex-col flex-1'>
      <Section id='print-management-platform' className='pb-24'>
          ...
          <CardContent className='flex flex-col gap-y-4 p-5 md:p-6'>
            ...
            <div className='flex flex-col gap-y-3'>
              ...
              <p className='font-mono text-neutral-700 dark:text-neutral-300 text-pretty'>
                Case study details for this private internal operations and production workflow platform will be added here.
              </p>
            </div>
          </CardContent>
        </Card>
