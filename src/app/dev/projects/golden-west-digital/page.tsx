...
export const metadata: Metadata = {
  title: 'Golden West Digital | Ryan Milne',
  description:
    'Golden West Digital SaaS platform case study placeholder for Ryan Milne developer portfolio.'
}

export default function GoldenWestDigitalPage() {
  return (
    <div className='flex flex-col flex-1'>
      <Section id='golden-west-digital' className='pb-24'>
          ...
          <CardContent className='flex flex-col gap-y-4 p-5 md:p-6'>
            ...
            <div className='flex flex-col gap-y-3'>
              ...
              <p className='font-mono text-neutral-700 dark:text-neutral-300 text-pretty'>
                Case study details for this contractor-focused SaaS platform will be added here.
              </p>
            </div>
          </CardContent>
        </Card>
