...
export const metadata: Metadata = {
  title: 'Timely Envelopes UX | Ryan Milne',
  description:
    'Timely Envelopes private workflow UX prototype case study placeholder for Ryan Milne portfolio.'
}

export default function TimelyEnvelopesUxPage() {
  return (
    <div className='flex flex-col flex-1'>
      <Section id='timely-envelopes-ux' className='pb-24'>
          ...
          <CardContent className='flex flex-col gap-y-4 p-5 md:p-6'>
            ...
            <div className='flex flex-col gap-y-3'>
              ...
              <p className='font-mono text-neutral-700 dark:text-neutral-300 text-pretty'>
                UX case study details for this private print-management prototype will be added here.
              </p>
            </div>
          </CardContent>
        </Card>
