    ...
    <div className='flex w-full flex-col flex-1 items-center'>
      ...
      >
        ...
        <div className='relative z-10 mx-auto flex w-full flex-col gap-y-6 px-4 pb-12 pt-28 md:max-w-5xl md:px-6 md:pb-16 md:pt-32'>
          <p className='font-mono text-sm font-medium uppercase tracking-wide text-neutral-400'>
            Ryan Milne
          </p>
          <div className='flex flex-col gap-y-3'>
            <h1 className='flex items-center gap-x-4 text-4xl font-bold text-neutral-50 text-balance md:text-5xl'>
              <MailIcon className='size-7 stroke-[1.5]' aria-hidden='true' />
              Contact
            </h1>
            <p className='max-w-2xl font-mono leading-relaxed text-neutral-300 text-pretty'>
